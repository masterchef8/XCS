class Cons:
    ...
    def __init__(self):
        ...
        self.theta_GA = 80 # The threshold for the GA application in an action set.
        self.theta_Select = 0.4   # Original Value as found in Butz 2002 Tournament Selection paper
        #self.theta_Select = 0.5    # The fraction of the action set to be included in tournament selection.
        self.epsilon_0 = 10  # The error threshold under which the accuracy of a classifier is set to one.
        ...
        self.pM = 0.04       # The probability of mutating one allele and the action in an offspring classifier.
